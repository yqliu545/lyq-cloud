...
CREATE TABLE `pay_info`  (
  ...
  UNIQUE INDEX `uqe_oder_no`(`order_no`) USING BTREE COMMENT '订单唯一',
  UNIQUE INDEX `uqe_trade_no`(`trade_no`) USING BTREE COMMENT '流水号唯一',
  CONSTRAINT `order_no_forign2` FOREIGN KEY (`order_no`) REFERENCES `t_order` (`order_no`) ON DELETE RESTRICT ON UPDATE RESTRICT
